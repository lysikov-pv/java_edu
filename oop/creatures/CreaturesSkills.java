...
public enum CreaturesSkills {
    Archer("Арбалетчик", 10, 6, 3, 2, 3, 100, 9, 12, 0),
    Mage("Маг", 25, 11, 8, 7, 9, 350, 8, 24, 4),
    Monk("Монах", 30, 12, 7, 10, 12, 400, 7, 12, 2),
    Peasant("Крестьянин", 1, 1, 1, 1, 1, 10, 1, 0, 0),
    Pikeman("Копейщик", 10, 4, 5, 1, 3, 60, 4, 0, 0),
    Sharpshooter("Снайпер", 15, 12, 10, 8, 10, 400, 10, 32, 0),
    Rogue("Разбойник", 4, 6, 1, 1, 2, 100, 10, 0, 0),
